...
/**
 * API key authentication security configuration identified by the term apikey (i.e., "scheme": "apikey"). This is for the case where the
 * access token is opaque and is not using a standard token format.<br>
