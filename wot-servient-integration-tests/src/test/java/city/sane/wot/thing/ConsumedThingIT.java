...
public class ConsumedThingIT {
    ...
    public void readPropertyShouldReturnCorrectValue(Class server,
                                                     Class clientFactory) throws ExecutionException, InterruptedException, ServientException {
    ...
    @ArgumentsSource(MyArgumentsProvider.class)
    @Timeout(value = 20, unit = SECONDS)
    public void writePropertyShouldUpdateValue(Class server,
                                               Class clientFactory) throws ExecutionException, InterruptedException, ServientException {
        Config config = ConfigFactory
                .parseString("wot.servient.servers = [\"" + server.getName() + "\"]\n" +
                        "wot.servient.client-factories = [\"" + clientFactory.getName() + "\"]")
    ...
    @ParameterizedTest
    @ArgumentsSource(MyArgumentsProvider.class)
    public void observePropertyShouldHandleMultipleSubscription(Class server,
                                                                Class clientFactory) throws ServientException, InterruptedException, ExecutionException {
        Config config = ConfigFactory
                .parseString("wot.servient.servers = [\"" + server.getName() + "\"]\n" +
                        "wot.servient.client-factories = [\"" + clientFactory.getName() + "\"]")
                .withFallback(ConfigFactory.load());
    ...
    @ArgumentsSource(MyArgumentsProvider.class)
    @Timeout(value = 20, unit = SECONDS)
    public void readPropertiesShouldReturnCorrectValues(Class server,
                                                        Class clientFactory) throws ExecutionException, InterruptedException, ServientException {
        Config config = ConfigFactory
                .parseString("wot.servient.servers = [\"" + server.getName() + "\"]\n" +
                        "wot.servient.client-factories = [\"" + clientFactory.getName() + "\"]")
    ...
    @ArgumentsSource(MyArgumentsProvider.class)
    @Timeout(value = 20, unit = SECONDS)
    public void readMultipleProperties(Class server,
                                       Class clientFactory) throws ExecutionException, InterruptedException, ServientException {
        Config config = ConfigFactory
                .parseString("wot.servient.servers = [\"" + server.getName() + "\"]\n" +
                        "wot.servient.client-factories = [\"" + clientFactory.getName() + "\"]")
    ...
    @ArgumentsSource(MyArgumentsProvider.class)
    @Timeout(value = 20, unit = SECONDS)
    public void invokeActionShouldExecuteDefinedTask(Class server,
                                                     Class clientFactory) throws ExecutionException, InterruptedException, ServientException {
        Config config = ConfigFactory
                .parseString("wot.servient.servers = [\"" + server.getName() + "\"]\n" +
                        "wot.servient.client-factories = [\"" + clientFactory.getName() + "\"]")
    ...
    @ArgumentsSource(MyArgumentsProvider.class)
    @Timeout(value = 20, unit = SECONDS)
    public void invokeActionWithParametersShouldExecuteDefinedTask(Class server,
                                                                   Class clientFactory) throws ExecutionException, InterruptedException, ServientException {
        Config config = ConfigFactory
                .parseString("wot.servient.servers = [\"" + server.getName() + "\"]\n" +
                        "wot.servient.client-factories = [\"" + clientFactory.getName() + "\"]")
    ...
    @ParameterizedTest
    @ArgumentsSource(MyArgumentsProvider.class)
    public void observeEventShouldHandleMultipleSubscription(Class server,
                                                             Class clientFactory) throws ServientException {
        Config config = ConfigFactory
                .parseString("wot.servient.servers = [\"" + server.getName() + "\"]\n" +
                        "wot.servient.client-factories = [\"" + clientFactory.getName() + "\"]")
                .withFallback(ConfigFactory.load());
