...
public class CoapProtocolClient implements ProtocolClient {
    ...
    public CoapProtocolClient(Function<String, CoapClient> clientCreator, Duration timeout) {
    ...
    class FutureCoapHandler implements CoapHandler {
        ...
        public void onError() {
            if (!future.isDone()) {
                future.completeExceptionally(new ProtocolClientException("request errored or has been rejected by the server"));
            }
        }
    }
}
